...
public class SelectHourActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,
        View.OnClickListener {

    private static final String TAG = SelectHourActivity.class.getSimpleName();
        ...
        myRef.child("2017").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    fileList4.add(snapshot.getValue().toString().replaceAll("_", "."));
                }
                Log.d(TAG, "onChildAdded: size = " + fileList4.size());
